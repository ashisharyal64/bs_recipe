...
//require recipe post type
require_once (get_template_directory().'/inc/cpt/recipe-post-type.php');
//require taxonomies
require_once (get_template_directory().'/inc/cpt/recipe-taxonomies.php');
...
function bootscore_scripts() {
	...
	// Theme JS
	wp_enqueue_script( 'bootscore-script', get_template_directory_uri() . '/js/theme.js', array('flexslider'), '20151215', true );
